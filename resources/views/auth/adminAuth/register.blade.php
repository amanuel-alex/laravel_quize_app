<x-layout>
    <div class="register-container w-[35vw] bg-white p-8 rounded-md shadow-md mx-auto">
        <h2 class="title text-2xl font-semibold text-center mb-4">Welcome to admin registration</h2>
        <div class="max-w-screen-sm text-left mx-auto">
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-4">
                ...
                <p class="link_element">Already have account ? <a  href="{{route('login')}}" class="hover:text-rose-300">Login</a></p>
            </form>
